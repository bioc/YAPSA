...
categories. These strata may be defined by genomic coordinate or other measures 
...
last two lines of equation (@SMC_formula) correspond to equation 
(@LCD_formula). The very last part of equation (@SMC_formula) reflects the 
